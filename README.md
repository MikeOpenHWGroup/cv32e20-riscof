# CV32E20 RISC-V Architectural Compatibility Testing using RISCOF
...
[CV32E20 RISC-V Processor](https://github.com/openhwgroup/cve2) for compatibility to the RISC-V ISA specifications.
...
* [cv32e20](https://github.com/openhwgroup/cve2) - the device under test (DUT)
...
* [Verilator](https://github.com/verilator/verilator) to simulate the SystemVerilog RTL model of the CV32E20

This repository uses `git submodules` to bring in the CV32E20 RTL and the RISC-V Architecture tests.

[[back to top](#CV32E20-RISC-V-Architectural-Compatibility-Testing-using-RISCOF)]
...
* DUT: `cv32e20` in directory **plugin-cv32e20**
...
<!-- TODO:
The final test report is made available as CSS-flavored HTML file via the [GitHib actions artifact](https://github.com/OpenHWGroup/cv32e20-riscof/actions).
-->
...
TODO: READMEs in `plugin-cv32e20/tb`and `plugin-cv32e20/env` directories of this repo attempt to document how this is done.
